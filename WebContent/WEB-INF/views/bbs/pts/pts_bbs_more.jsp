...
<body>
			...
			<div class="test">
				...
				<div class="test_container">
					...
					<div class="assess_content">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;<span style="margin-left:20px">帖子总数：${topic.postNum }</span><span style="margin-left:20px">创建时间：${topic.createTime }</span>
						<span style="margin-left:20px">更新时间：${topic.updateTime }</span>
						</h4>
	...
	<script>
		$(function(){
			...
			$("#next").click(function(){
				currPage=++currPage;
				window.location.href="${pageContext.request.contextPath }/ptsBBS/toSeeMore?topicId="+topicId+"&page="+currPage;
			})
			$("#pre").click(function(){
				currPage=--currPage;
				window.location.href="${pageContext.request.contextPath }/ptsBBS/toSeeMore?topicId="+topicId+"&page="+currPage;
